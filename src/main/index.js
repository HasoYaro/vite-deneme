...
app.whenReady().then(() => {
  ...
  autoUpdater.on('update-available', (info) => {
    mainWindow.webContents.send('updateState', 'updateFound')
    let pth = autoUpdater.downloadUpdate()
    mainWindow.webContents.send('updateState', pth)
})

autoUpdater.on('update-not-available', (info) => {
    mainWindow.webContents.send('updateState', 'updateNotFound')
    mainWindow.webContents.send('updateState', pth)
})


autoUpdater.on('update-donwloaded', (info) => {
    mainWindow.webContents.send('updateState', 'updateDownloaded')
})
